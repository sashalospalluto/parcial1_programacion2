...
{    
    public class Producto
    {
        ...
        public static void ModificarStock(List<Producto> lista, Producto producto)
        {
            foreach (Producto listaProductos in lista)
            {
                if (listaProductos.nombre == producto.nombre)
                {
                    listaProductos.cantidad -= producto.cantidad;
                    break;
                }
            }
        }
